...
<style>
	...
	<div id="login-container">
		...
		<div style="width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;">
			<form id="findId" class="point" action="${pageContext.request.contextPath}/member/findidend.do" method="post">
				...
				<input type="submit" value="아이디 찾기" style="background-color:#ffccbc">
			</form>
		</div>
	</div>
	<script>
